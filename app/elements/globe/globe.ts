...
export class UIGlobe extends LitElement {
  ...
  @property({ type: Number, attribute: 'auto-rotate-speed' }) autoRotateSpeed = 0.01;
  ...
  @property({ type: Array, attribute: 'base-color' }) baseColor: [number, number, number] = [0.3, 0.3, 0.3];
  @property({ type: Array, attribute: 'marker-color' }) markerColor: [number, number, number] = [0.1, 0.8, 1];
  @property({ type: Array, attribute: 'glow-color' }) glowColor: [number, number, number] = [1, 1, 1];

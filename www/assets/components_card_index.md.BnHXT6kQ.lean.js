...
.p-8 {
  padding: 2rem
    ...
    `}};Jt(R,"styles",kt`
    ${rt(qt)}
  `);dt([Lt({type:String})],R.prototype,"variant",2);R=dt([Ft("ui-card")],R);const Kt=m("h1",{id:"card",tabindex:"-1"},[nt("Card "),m("a",{class:"header-anchor",href:"#card","aria-label":'Permalink to "Card"'},"​")],-1),Zt=m("p",null,"This page demonstrates some of the built-in markdown extensions provided by VitePress.",-1),Qt=m("h2",{id:"example",tabindex:"-1"},[nt("Example "),m("a",{class:"header-anchor",href:"#example","aria-label":'Permalink to "Example"'},"​")],-1),Yt={class:"p-8 bg-gradient-to-b from-indigo-50 to-transparent rounded-2xl"},Xt=m("p",{slot:"one"},'Include me in slot "one".',-1),te=m("p",{slot:"two"},'Include me in slot "two".',-1),ee=yt("",17),re=JSON.parse('{"title":"Card","description":"","frontmatter":{},"headers":[],"relativePath":"components/card/index.md","filePath":"components/card/index.md"}'),se={name:"components/card/index.md"},oe=Object.assign(se,{setup(n){return(t,e)=>{const s=Et("ui-card");return wt(),_t("div",null,[Kt,Zt,Qt,m("div",Yt,[mt(s,null,{default:ft(()=>[Xt,te]),_:1})]),ee])}}});export{re as __pageData,oe as default};

...
/* Utilities — presentational / tooling surfaces. */
export * from './utilities/code-block';
...
/* Utilities — side-effect imports for custom element registration. */
import './utilities/code-block';

"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const r=require("lit"),l=require("./registry-Bpi-HjGd.cjs");var d=Object.getOwnPropertyDescriptor,c=(e,n,i,a)=>{for(var t=a>1?void 0:a?d(n,i):n,o=e.length-1,s;o>=0;o--)(s=e[o])&&(t=s(t)||t);return t};exports.DotsBackground=class extends r.LitElement{render(){return r.html`
      <div class="container">
        <div class="ui-bg-dots-pattern"></div>
        <div class="dot-mask-gradient"></div>
        <slot></slot>
      </div>
    `}};exports.DotsBackground.styles=r.css`
    :host {
  ...
  `;exports.DotsBackground=c([l.chargedCustomElement("ui-bg-dots")],exports.DotsBackground);
